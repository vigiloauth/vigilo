	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			rr := testContext.SendHTTPRequest(
				http.MethodPost,
				utils.UserEndpoints.Registration,
...
func TestUserHandler_UserAuthentication(t *testing.T) {
	...
	t.Run("Protected Route With Expired Token", func(t *testing.T) {
		...
		rr := testContext.SendHTTPRequest(http.MethodPost, utils.UserEndpoints.Logout, nil, nil)
	...
	t.Run("Request Password Reset Email", func(t *testing.T) {
		...
		for _, tc := range testCases {
			t.Run(tc.name, func(t *testing.T) {
				...
				rr := testContext.SendHTTPRequest(
					http.MethodPost,
					utils.UserEndpoints.RequestPasswordReset,
	...
	t.Run("Reset Password", func(t *testing.T) {
		...
		for _, tc := range testCases {
			t.Run(tc.name, func(t *testing.T) {
				...
				rr := testContext.SendHTTPRequest(
					http.MethodPatch,
					utils.UserEndpoints.ResetPassword,
					bytes.NewBuffer(requestBody),
					nil,
				)
